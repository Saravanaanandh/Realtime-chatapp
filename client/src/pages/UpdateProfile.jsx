...
const UpdateProfile = () => {
    ...
    return (
      <div className="w-full min-h-fit flex items-center justify-center bg-gray-900  text-blue-500 py-5 max-sm:text-[0.9rem]">
        <div className="max-w-[500px] h-auto flex flex-1 mx-5 p-3 bg-gray-800 rounded-2xl flex-col md:px-10">  
          <div>
